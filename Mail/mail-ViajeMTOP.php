                            ...
                            <tr>
                                <td>
                                    <div class="mail-content" style="width: 500px; margin: 20px auto; background: #fff; font-family: Montserrat; color: #3844bc;">
                                        ...
                                        <p style="font-size: 14px;"><b style="color: #444; margin-right: 5px;">Origen: </b>'.$datos_viajeMTOP[0]['PAIS_ORIGEN'].', '.$datos_viajeMTOP[0]['DEPARTAMENTO_ORIGEN'].', '.$datos_viajeMTOP[0]['LOCALIDAD_ORIGEN'].'.</p>
                                        <p style="font-size: 14px;"><b style="color: #444; margin-right: 5px;">Destino: </b>'.$datos_viajeMTOP[0]['PAIS_DESTINO'].', '.$datos_viajeMTOP[0]['DEPARTAMENTO_DESTINO'].', '.$datos_viajeMTOP[0]['LOCALIDAD_DESTINO'].'.</p>
