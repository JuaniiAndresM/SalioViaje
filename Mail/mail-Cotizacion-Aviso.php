...
$mail->addAddress($mail_solicitante);
$mail->isHTML(true);
$mail->Subject = "Ya hay cotizaciones para tu viaje #".$id.". - SalióViaje";
                            ...
                            <tr>
                                <td style="text-align: center;">
                                    <div style="background-color: #dfdfdf; width: 500px; margin: 20px auto; text-align: left; font-family: Montserrat; font-size: 13px; border-left: 3px solid #3844bc; padding: 5px 10px; box-sizing: border-box; color: #3844bc;">
                                        <p>¡Buenas Noticias!</p>    
                                        <b>Ya hay cotizaciones para el viaje que cotizaste.</b>
                                        <p></p>
                                    </div>
                            ...
                            <tr>
                                <td>
                                    <div class="mail-content" style="width: 500px; margin: 20px auto; background: #fff; font-family: Montserrat; color: #3844bc;">
                                        <p style="font-size: 13px; color: #555;">Felicidades, ya llegarón las primeras cotizaciones para tu viaje #'.$id.', visita el dashboard para ver las diferentes propuestas.</p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>
                                    <div class="mail-content" style="width: 95%; margin: 20px auto; background: #fff; font-family: Montserrat; color: #555; font-size: 13px;">
                                        <p>Este mensaje se envió a <span style="color: #3844bc; font-weight: bold;">'.$mail_solicitante.'</span>.</p>
